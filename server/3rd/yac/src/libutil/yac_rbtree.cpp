...
bool YAC_RBTree::Block::hasLeft()
{
    return _pHead->_iLeftChild != 0;
}

bool YAC_RBTree::Block::moveToLeft()
{
...
bool YAC_RBTree::Block::hasRight()
{
    return _pHead->_iRightChild != 0;
}

bool YAC_RBTree::Block::moveToRight()
{
...
bool YAC_RBTree::Block::hasParent()
{
    return _pHead->_iParent != 0;
}

bool YAC_RBTree::Block::moveToParent()
{
...
void YAC_RBTree::Block::rotateLeft(YAC_RBTree::Block::tagBlockHead *i, uint32_t iAddr)
{
    assert(i != NULL);
...
|  a   b             b   y
-----------------------------------------------------------*/
void YAC_RBTree::Block::rotateRight(YAC_RBTree::Block::tagBlockHead *i, uint32_t iAddr)
{
    assert(i != NULL);
//    assert(iAddr == _pMap->getRelative(i));
...
void YAC_RBTree::Block::eraseFixUp(YAC_RBTree::Block::tagBlockHead *i, uint32_t iAddr, YAC_RBTree::Block::tagBlockHead *p, uint32_t iPAddr)
{
//    assert(iAddr == _pMap->getRelative(i));
...
void YAC_RBTree::Block::erase(YAC_RBTree::Block::tagBlockHead *i, uint32_t iAddr)
{
    assert(i != NULL);
//    assert(iAddr == _pMap->getRelative(i));
...
void YAC_RBTree::Block::insertFixUp(YAC_RBTree::Block::tagBlockHead *i, uint32_t iAddr)
{
    tagBlockHead *p = NULL;
    uint32_t iPAddr = 0;
    tagBlockHead *g = NULL;
...
void YAC_RBTree::Block::insertGetSetList(YAC_RBTree::Block::tagBlockHead *i)
{
    //挂在Set链表的头部
...
void YAC_RBTree::Block::insertRBTree(tagBlockHead *i, const string &k)
{
    ...
    else
    {
        ...
        assert(iRet == YAC_RBTree::RT_OK || iRet == YAC_RBTree::RT_ONLY_KEY);
...
int YAC_RBTree::Block::set(const string& k, const string& v, bool bNewBlock, bool bOnlyKey, vector<YAC_RBTree::BlockData> &vtData)
{
    YAC_PackIn pi;
    pi << k;
    ...
    return YAC_RBTree::RT_OK;
}

int YAC_RBTree::Block::getBlockData(YAC_RBTree::BlockData &data)
{
    data._dirty = isDirty();
    ...
    try
    {
        ...
        {
            return YAC_RBTree::RT_ONLY_KEY;
        }
    }
    catch(exception &ex)
    {
        assert(false);
        ret = YAC_RBTree::RT_DECODE_ERR;
    }

    return ret;
}

int YAC_RBTree::Block::get(void *pData, uint32_t &iDataLen)
{
    tagBlockHead *i = getBlockHead();
    ...
    else
    {
        ...
        {
            return YAC_RBTree::RT_NOTALL_ERR;   //copy数据不完全
        }
        ...
        while(iHasLen < iDataLen)
        {
            ...
            if(!pChunk->_bNextChunk)
            {
                ...
                {
                    return YAC_RBTree::RT_NOTALL_ERR;       //copy不完全
                }
...
int YAC_RBTree::Block::get(string &s)
{
...
void YAC_RBTree::Block::setDirty(bool b)
{
    tagBlockHead *i = getBlockHead();
...
void YAC_RBTree::Block::deallocate()
{
    tagBlockHead *i = getBlockHead();
...
void YAC_RBTree::Block::makeNew(uint32_t iAllocSize)
{
    tagBlockHead *i    = getBlockHead();

    i->_iSize          = iAllocSize;
    i->_iColor         = YAC_RBTree::RED;
    i->_iParent        = 0;
    i->_iLeftChild     = 0;
    i->_iRightChild    = 0;
    i->_iSetNext       = 0;
...
void YAC_RBTree::Block::erase()
{
    ...
    _pMap->saveValue(&i->_iColor, YAC_RBTree::RED, false);
...
void YAC_RBTree::Block::refreshSetList()
{
    tagBlockHead *i = getBlockHead();
...
void YAC_RBTree::Block::refreshGetList()
{
...
void YAC_RBTree::Block::deallocate(uint32_t iChunk)
{
...
int YAC_RBTree::Block::allocate(uint32_t iDataLen, vector<YAC_RBTree::BlockData> &vtData)
{
    uint32_t fn   = 0;
...
int YAC_RBTree::Block::joinChunk(tagChunkHead *pChunk, const vector<uint32_t> chunks)
{
...
int YAC_RBTree::Block::allocateChunk(uint32_t fn, vector<uint32_t> &chunks, vector<YAC_RBTree::BlockData> &vtData)
{
    assert(fn > 0);
    ...
    while(true)
    {
        ...
        if (t == 0)
        {
            ...
            chunks.clear();
            return YAC_RBTree::RT_NO_MEMORY;
        }
...
uint32_t YAC_RBTree::Block::getDataLen()
{
    tagBlockHead *i = getBlockHead();
...
////////////////////////////////////////////////////////
// 
uint32_t YAC_RBTree::BlockAllocator::allocateMemBlock(uint32_t &iAllocSize, vector<YAC_RBTree::BlockData> &vtData)
{
begin:
    size_t iIndex;
...
uint32_t YAC_RBTree::BlockAllocator::allocateChunk(uint32_t iAddr, uint32_t &iAllocSize, vector<YAC_RBTree::BlockData> &vtData)
{
begin:
    size_t iIndex;
    size_t iTmp1 = (size_t)iAllocSize;
...
void YAC_RBTree::BlockAllocator::deallocateMemBlock(const vector<uint32_t> &v)
{
...
void YAC_RBTree::BlockAllocator::deallocateMemBlock(uint32_t v)
{
...
YAC_RBTree::RBTreeLockItem::RBTreeLockItem(YAC_RBTree *pMap, uint32_t iAddr)
: _pMap(pMap)
, _iAddr(iAddr)
{
}

YAC_RBTree::RBTreeLockItem::RBTreeLockItem(const RBTreeLockItem &mcmdi)
: _pMap(mcmdi._pMap)
, _iAddr(mcmdi._iAddr)
{
}

YAC_RBTree::RBTreeLockItem &YAC_RBTree::RBTreeLockItem::operator=(const YAC_RBTree::RBTreeLockItem &mcmdi)
{
    if(this != &mcmdi)
    {
        _pMap   = mcmdi._pMap;
...
bool YAC_RBTree::RBTreeLockItem::operator==(const YAC_RBTree::RBTreeLockItem &mcmdi)
{
...
bool YAC_RBTree::RBTreeLockItem::isDirty()
{
    Block block(_pMap, _iAddr);
    return block.isDirty();
}

bool YAC_RBTree::RBTreeLockItem::isOnlyKey()
{
    Block block(_pMap, _iAddr);
    return block.isOnlyKey();
}

time_t YAC_RBTree::RBTreeLockItem::getSyncTime()
{
    Block block(_pMap, _iAddr);
    return block.getSyncTime();
}

int YAC_RBTree::RBTreeLockItem::get(string& k, string& v)
{
    string s;
    ...
    {
        assert(false);
        return YAC_RBTree::RT_EXCEPTION_ERR;
    }

    return YAC_RBTree::RT_OK;
}

int YAC_RBTree::RBTreeLockItem::get(string& k)
{
    string s;
...
int YAC_RBTree::RBTreeLockItem::set(const string& k, const string& v, bool bNewBlock, vector<YAC_RBTree::BlockData> &vtData)
{
    Block block(_pMap, _iAddr);
...
int YAC_RBTree::RBTreeLockItem::set(const string& k, bool bNewBlock, vector<YAC_RBTree::BlockData> &vtData)
{
    Block block(_pMap, _iAddr);
...
bool YAC_RBTree::RBTreeLockItem::equal(const string &k, string &k1, string &v, int &ret)
{
    ret = get(k1, v);

    if ((ret == YAC_RBTree::RT_OK || ret == YAC_RBTree::RT_ONLY_KEY) && k == k1)
    {
        return true;
    }
...
bool YAC_RBTree::RBTreeLockItem::equal(const string& k, string &k1, int &ret)
{
    ret = get(k1);

    if (ret == YAC_RBTree::RT_OK && k == k1)
    {
        return true;
    }
...
void YAC_RBTree::RBTreeLockItem::nextItem(int iType)
{
    Block block(_pMap, _iAddr);
...
void YAC_RBTree::RBTreeLockItem::prevItem(int iType)
{
    Block block(_pMap, _iAddr);
...
YAC_RBTree::RBTreeLockIterator::RBTreeLockIterator()
: _pMap(NULL), _iItem(NULL, 0)
{
}

YAC_RBTree::RBTreeLockIterator::RBTreeLockIterator(YAC_RBTree *pMap, uint32_t iAddr, int iType, int iOrder)
: _pMap(pMap), _iItem(_pMap, iAddr), _iType(iType), _iOrder(iOrder)
{
}

YAC_RBTree::RBTreeLockIterator::RBTreeLockIterator(const RBTreeLockIterator &it)
: _pMap(it._pMap),_iItem(it._iItem), _iType(it._iType), _iOrder(it._iOrder)
{
}

YAC_RBTree::RBTreeLockIterator& YAC_RBTree::RBTreeLockIterator::operator=(const RBTreeLockIterator &it)
{
    if(this != &it)
    {
        _pMap       = it._pMap;
...
bool YAC_RBTree::RBTreeLockIterator::operator==(const RBTreeLockIterator& mcmi)
{
...
YAC_RBTree::RBTreeLockIterator& YAC_RBTree::RBTreeLockIterator::operator++()
{
    if(_iOrder == IT_NEXT)
    {
...
YAC_RBTree::RBTreeLockIterator YAC_RBTree::RBTreeLockIterator::operator++(int)
{
...
YAC_RBTree::RBTreeItem::RBTreeItem(YAC_RBTree *pMap, const string &key, bool bEnd)
: _pMap(pMap)
, _key(key)
, _bEnd(bEnd)
{
...
YAC_RBTree::RBTreeItem::RBTreeItem(const YAC_RBTree::RBTreeItem &mcmdi)
: _pMap(mcmdi._pMap)
, _key(mcmdi._key)
, _bEnd(mcmdi._bEnd)
{
...
YAC_RBTree::RBTreeItem &YAC_RBTree::RBTreeItem::operator=(const YAC_RBTree::RBTreeItem &mcmdi)
{
    if(this != &mcmdi)
    {
        _pMap   = mcmdi._pMap;
...
bool YAC_RBTree::RBTreeItem::operator==(const YAC_RBTree::RBTreeItem &mcmdi)
{
...
int YAC_RBTree::RBTreeItem::get(YAC_RBTree::BlockData &stData)
{
    if(_bEnd)
    {
        return YAC_RBTree::RT_NO_DATA;
    }

    YAC_RBTree::lock_iterator it = _pMap->find(_key);
    if(it != _pMap->end())
    {
...
void YAC_RBTree::RBTreeItem::nextItem()
{
    if(_bEnd)
    {
        return;
    ...
    string k;
    int ret;
    YAC_RBTree::lock_iterator it = _pMap->upper_bound(_key);

    while(it != _pMap->end())
    {
        ret = it->get(k);

        if(ret != YAC_RBTree::RT_OK && ret != YAC_RBTree::RT_ONLY_KEY)
        {
            //数据有错
            ++it;
            continue;
...
void YAC_RBTree::RBTreeItem::prevItem()
{
    if(_bEnd)
    {
        return;
    ...
    string k;
    int ret;
    YAC_RBTree::lock_iterator it1 = _pMap->lower_bound(_key);
    YAC_RBTree::lock_iterator it(_pMap, it1->getAddr(), YAC_RBTree::lock_iterator::IT_RBTREE, YAC_RBTree::lock_iterator::IT_PREV);
...
YAC_RBTree::RBTreeIterator::RBTreeIterator()
: _pMap(NULL), _iItem(NULL, "", true)
{
}

YAC_RBTree::RBTreeIterator::RBTreeIterator(YAC_RBTree *pMap, const string &key, bool bEnd, int iOrder)
: _pMap(pMap), _iItem(_pMap, key, bEnd), _iOrder(iOrder)
{
}

YAC_RBTree::RBTreeIterator::RBTreeIterator(const RBTreeIterator &it)
: _pMap(it._pMap),_iItem(it._iItem), _iOrder(it._iOrder)
{
}

YAC_RBTree::RBTreeIterator& YAC_RBTree::RBTreeIterator::operator=(const RBTreeIterator &it)
{
    if(this != &it)
    {
        _pMap       = it._pMap;
...
bool YAC_RBTree::RBTreeIterator::operator==(const RBTreeIterator& mcmi)
{
...
YAC_RBTree::RBTreeIterator& YAC_RBTree::RBTreeIterator::operator++()
{
    if(_iOrder == IT_NEXT)
    {
        _iItem.nextItem();
...
YAC_RBTree::RBTreeIterator YAC_RBTree::RBTreeIterator::operator++(int)
{
...
void YAC_RBTree::init(void *pAddr)
{
    _pHead          = static_cast<tagMapHead*>(pAddr);
    _pstModifyHead  = static_cast<tagModifyHead*>((void*)((char*)pAddr + sizeof(tagMapHead)));
}

void YAC_RBTree::initDataBlockSize(uint32_t iMinDataSize, uint32_t iMaxDataSize, float fFactor)
{
...
void YAC_RBTree::create(void *pAddr, size_t iSize)
{
    if(sizeof(tagMapHead)
       ...
       + 10 > iSize)
    {
        throw YAC_RBTree_Exception("[YAC_RBTree::create] mem size not enougth.");
    }

    if(_iMinDataSize == 0 || _iMaxDataSize == 0 || _fFactor < 1.0)
    {
        throw YAC_RBTree_Exception("[YAC_RBTree::create] init data size error:" + YAC_Common::tostr(_iMinDataSize) + "|" + YAC_Common::tostr(_iMaxDataSize) + "|" + YAC_Common::tostr(_fFactor));
    }
    ...
    {
        throw YAC_RBTree_Exception("[YAC_RBTree::create] init block size error, block size must be less then " + YAC_Common::tostr((uint16_t)(-1) - sizeof(Block::tagBlockHead)));
    }
...
void YAC_RBTree::connect(void *pAddr, size_t iSize)
{
    init(pAddr);
    ...
    if(_pHead->_cMaxVersion != MAX_VERSION || _pHead->_cMinVersion != MIN_VERSION)
    {
        ...
        throw YAC_RBTree_Exception("[YAC_RBTree::connect] rbtree map version not equal:" + os.str() + " (data != code)");
    }

    if(_pHead->_iMemSize != iSize)
    {
        throw YAC_RBTree_Exception("[YAC_RBTree::connect] rbtree map size not equal:" + YAC_Common::tostr(_pHead->_iMemSize) + "!=" + YAC_Common::tostr(iSize));
    }
...
int YAC_RBTree::append(void *pAddr, size_t iSize)
{
    ...
    if(_pHead->_cMaxVersion != MAX_VERSION || _pHead->_cMinVersion != MIN_VERSION)
    {
        ostringstream os;
        os << (int)_pHead->_cMaxVersion << "." << (int)_pHead->_cMinVersion << " != " << ((int)MAX_VERSION) << "." << ((int)MIN_VERSION);
        throw YAC_RBTree_Exception("[YAC_RBTree::append] rbtree map version not equal:" + os.str() + " (data != code)");
    }
...
int YAC_RBTree::dump2file(const string &sFile)
{
...
int YAC_RBTree::load5file(const string &sFile)
{
...
int YAC_RBTree::checkDirty(const string &k)
{
    FailureRecover check(this);

    incGetCount();

    int ret         = YAC_RBTree::RT_OK;
    ...
    if (block.isDirty())
    {
        return YAC_RBTree::RT_DIRTY_DATA;
    }

    return YAC_RBTree::RT_OK;
}

int YAC_RBTree::setDirty(const string& k)
{
    FailureRecover check(this);
...
int YAC_RBTree::setClean(const string& k)
{
    FailureRecover check(this);
...
int YAC_RBTree::get(const string& k, string &v, time_t &iSyncTime)
{
    FailureRecover check(this);
...
int YAC_RBTree::get(const string& k, string &v)
{
    time_t iSyncTime;
    return get(k, v, iSyncTime);
}

int YAC_RBTree::set(const string& k, const string& v, bool bDirty, vector<BlockData> &vtData)
{
    FailureRecover check(this);
    incGetCount();
...
int YAC_RBTree::set(const string& k, vector<BlockData> &vtData)
{
    FailureRecover check(this);
...
int YAC_RBTree::del(const string& k, BlockData &data)
{
    FailureRecover check(this);
...
int YAC_RBTree::erase(int radio, BlockData &data, bool bCheckDirty)
{
    FailureRecover check(this);
    ...
    if(ret == YAC_RBTree::RT_OK)
    {
        return YAC_RBTree::RT_ERASE_OK;
    }

    return ret;
}

void YAC_RBTree::sync()
{
    FailureRecover check(this);
...
int YAC_RBTree::sync(time_t iNowTime, BlockData &data)
{
    FailureRecover check(this);
...
void YAC_RBTree::backup(bool bForceFromBegin)
{
    FailureRecover check(this);
...
int YAC_RBTree::backup(BlockData &data)
{
    FailureRecover check(this);
    ...
    if(ret == YAC_RBTree::RT_OK)
    {
        return YAC_RBTree::RT_NEED_BACKUP;
    }
    return ret;
}
...
YAC_RBTree::nolock_iterator YAC_RBTree::nolock_begin()
{
    FailureRecover check(this);
...
YAC_RBTree::nolock_iterator YAC_RBTree::nolock_rbegin()
{
    FailureRecover check(this);
...
YAC_RBTree::lock_iterator YAC_RBTree::begin()
{
    FailureRecover check(this);
...
YAC_RBTree::lock_iterator YAC_RBTree::rbegin()
{
    FailureRecover check(this);
...
YAC_RBTree::lock_iterator YAC_RBTree::find(const string& k)
{
    FailureRecover check(this);
    int ret;
...
YAC_RBTree::lock_iterator YAC_RBTree::rfind(const string& k)
{
    FailureRecover check(this);
    int ret;
...
YAC_RBTree::lock_iterator YAC_RBTree::lower_bound(const string &k)
{
    FailureRecover check(this);
...
YAC_RBTree::lock_iterator YAC_RBTree::upper_bound(const string &k)
{
    FailureRecover check(this);
...
pair<YAC_RBTree::lock_iterator, YAC_RBTree::lock_iterator> YAC_RBTree::equal_range(const string& k1, const string &k2)
{
    FailureRecover check(this);
...
uint32_t YAC_RBTree::eraseExcept(uint32_t iNowAddr, vector<BlockData> &vtData)
{
    //在真正数据淘汰前使修改生效
    doUpdate();
    ...
    while (d != 0)
    {
        ...
        //判断按照哪种方式淘汰
        if(_pHead->_cEraseMode == YAC_RBTree::ERASEBYSET)
        {
        ...
        else if(ret == YAC_RBTree::RT_NO_DATA)
        {
            d--;
        }
...
YAC_RBTree::Block YAC_RBTree::getLastBlock(const string &k)
{
    ...
    while(iNowAddr != 0)
    {
        ...
        if(iRet != YAC_RBTree::RT_OK && iRet != YAC_RBTree::RT_ONLY_KEY)
        {
            block.erase();
            //数据块有问题,删除后,自恢复
...
YAC_RBTree::lock_iterator YAC_RBTree::find(uint32_t iAddr, const string& k, int &ret, bool bOrder)
{
    if(iAddr == 0)
        return end();

    ret = YAC_RBTree::RT_OK;
...
YAC_RBTree::lock_iterator YAC_RBTree::find(uint32_t iAddr, const string& k, string &v, int &ret)
{
    if(iAddr == 0)
        return end();
