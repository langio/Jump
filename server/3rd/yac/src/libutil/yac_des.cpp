...
void YAC_Des::scrunch(register const char *outof, register uint32_t *into)
{
    *into    = (*outof++ & 0xffL) << 24;
    *into   |= (*outof++ & 0xffL) << 16;
    *into   |= (*outof++ & 0xffL) << 8;
...
void YAC_Des::unscrun(register uint32_t *outof, register char *into)
{
    *into++ = (*outof >> 24) & 0xffL;
    *into++ = (*outof >> 16) & 0xffL;
    *into++ = (*outof >>  8) & 0xffL;
...
void YAC_Des::desfunc(register uint32_t *block, register uint32_t *keys)
{
...
void YAC_Des::cookey(register uint32_t *raw1, uint32_t *k)
{
...
void YAC_Des::deskey(const char *key, short edf, uint32_t *k)
{
...
void YAC_Des::des(const char *inblock, char *outblock, uint32_t *KnL)
{
    uint32_t work[2];
...
void YAC_Des::des3key(const char *hexkey, short mode, uint32_t *KnL, uint32_t *KnR, uint32_t *Kn3)
{
...
void YAC_Des::des3(const char *from, char *into, uint32_t *KnL, uint32_t *KnR, uint32_t *Kn3)
{
	uint32_t work[2];
...
string YAC_Des::encrypt(const char *key, const char * sIn, size_t iInlen)
{
    char des_key[8]  = {0};
    char des_input[8]  = {0};
    char des_output[8] = {0};
...
string YAC_Des::decrypt(const char *key, const char * sIn, size_t iInlen)
{
    char des_key[8]  = {0};
    char des_input[8]  = {0};
    char des_output[8] = {0};
...
string YAC_Des::encrypt3(const char *key, const char * sIn, size_t iInlen)
{
    char des_key[24] = {0};
...
string YAC_Des::decrypt3(const char *key, const char * sIn, size_t iInlen)
{
    try
    {
        char des_key[24] = {0};
    ...
    catch(YAC_DES_Exception &e)
    {
        string res = "YAC_Des::decrypt3 error" + string(e.what());
        throw YAC_DES_Exception(res);
    }
}
