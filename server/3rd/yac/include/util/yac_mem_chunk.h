#ifndef	__YAC_MEM_CHUNK_H__
#define __YAC_MEM_CHUNK_H__
...
/////////////////////////////////////////////////
/**
* @brief 原始内存块, 由YAC_MemChunkAllocator来负责分配和维护
*
...
* Chunk个数, 4个字节 ;
*  
* YAC_MemChunk 暂时只支持同一个Block大小的MemChunk 
*/
class YAC_MemChunkAllocator
{
public:
	...
	*/
     ...
     * @return 头部信息
     */
    YAC_MemChunk::tagChunkHead getBlockDetail() const;
...
protected:
	...
	*@brief 不允许copy构造 
	*/ 
    YAC_MemChunkAllocator(const YAC_MemChunkAllocator &);
	/**
	 *@brief 不允许赋值  
	 */ 
    YAC_MemChunkAllocator& operator=(const YAC_MemChunkAllocator &);
    bool operator==(const YAC_MemChunkAllocator &mca) const;
    bool operator!=(const YAC_MemChunkAllocator &mca) const;
 ...
 *  
 * 内部每种块用YAC_MemChunkAllocator来分配, 
 *  
 ...
 */
class YAC_MemMultiChunkAllocator
{
public:
    ...
    */
     ...
     */
    vector<YAC_MemChunk::tagChunkHead> getBlockDetail() const;
...
protected:
     ...
     * @brief 最后一个分配器
     * 
     * @return YAC_MemMultiChunkAllocator*
     */
    YAC_MemMultiChunkAllocator *lastAlloc();

	/**
	 *@brief 不允许copy构造
	 */
    YAC_MemMultiChunkAllocator(const YAC_MemMultiChunkAllocator &);
	/** 
	  * @brief 不允许赋值
	  */
    YAC_MemMultiChunkAllocator& operator=(const YAC_MemMultiChunkAllocator &);
    bool operator==(const YAC_MemMultiChunkAllocator &mca) const;
    bool operator!=(const YAC_MemMultiChunkAllocator &mca) const;
...
private:
     ...
     * chunk链表
     */
    vector<YAC_MemChunkAllocator*>       _allocator;
     ...
     * 后续的多块分配器
     */
    YAC_MemMultiChunkAllocator           *_nallocator;
};
