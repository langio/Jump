#ifndef __YAC_ENCODER_H_
#define __YAC_ENCODER_H_
...
*  @brief  转码异常类
*/
struct YAC_Encoder_Exception : public YAC_Exception
{
	YAC_Encoder_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_Encoder_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
	~YAC_Encoder_Exception() throw(){};
};
