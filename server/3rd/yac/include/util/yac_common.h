#ifndef __YAC_COMMON_H
#define __YAC_COMMON_H
...
template<typename T>
T YAC_Common::strto(const string &sStr)
{
...
template<typename T>
T YAC_Common::strto(const string &sStr, const string &sDefault)
{
    string s;
...
template<typename T>
vector<T> YAC_Common::sepstr(const string &sStr, const string &sSep, bool withEmpty)
{
    vector<T> vt;
...
template<typename T>
string YAC_Common::tostr(const T &t)
{
...
template<typename T>
string YAC_Common::tostr(const vector<T> &t)
{
    ostringstream sBuffer;
...
template<typename K, typename V, typename D, typename A>
string YAC_Common::tostr(const map<K, V, D, A> &t)
{
    ostringstream sBuffer;
...
template<typename K, typename V, typename D, typename A>
string YAC_Common::tostr(const multimap<K, V, D, A> &t)
{
    ostringstream sBuffer;
...
template<typename F, typename S>
string YAC_Common::tostr(const pair<F, S> &itPair)
{
    ostringstream sBuffer;
...
template <typename InputIter>
string YAC_Common::tostr(InputIter iFirst, InputIter iLast, const string &sSep)
{
    string sBuffer;
    InputIter it = iFirst;
