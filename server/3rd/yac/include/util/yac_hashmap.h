#ifndef	__YAC_HASHMAP_H__
#define __YAC_HASHMAP_H__
...
* @brief Hash map异常类
*/
struct YAC_HashMap_Exception : public YAC_Exception
{
	YAC_HashMap_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_HashMap_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_HashMap_Exception() throw(){};
};
 ...
 * 
 *该hashmap通过YAC_MemMutilChunkAllocator来分配空间，支持不同大小的内存块的分配； 
 * 
...
public:
    ...
    */
    ...
    public:
         ...
         */
        Block(YAC_HashMap *pMap, size_t iAddr)
        : _pMap(pMap)
        , _iHead(iAddr)
        {
        }
         ...
         *
         * @return int
         *          YAC_HashMap::RT_OK, 正常, 其他异常
         *          YAC_HashMap::RT_ONLY_KEY, 只有Key
         *          其他异常
         */
        int getBlockData(YAC_HashMap::BlockData &data);
         ...
         * @param vtData, 淘汰的数据
         */
        int set(const void *pData, size_t iDataLen, bool bOnlyKey, vector<YAC_HashMap::BlockData> &vtData);
    ...
    protected:
         ...
         * @return int,
         */
        int allocate(size_t iDataLen, vector<YAC_HashMap::BlockData> &vtData);
         ...
         * @return int
         */
        int allocateChunk(size_t fn, vector<size_t> &chunks, vector<YAC_HashMap::BlockData> &vtData);
    ...
    */
    ...
    public:
         ...
         * @brief 构造函数
         */
        BlockAllocator(YAC_HashMap *pMap)
        : _pMap(pMap)
         ...
         */
        size_t allocateMemBlock(size_t index, size_t &iAllocSize, vector<YAC_HashMap::BlockData> &vtData);
         ...
         * @return size_t, 相对地址,0表示没有空间可以分配
         */
        size_t allocateChunk(size_t iAddr, size_t &iAllocSize, vector<YAC_HashMap::BlockData> &vtData);
    ...
    public:
         ...
         * @param iAddr
    	 */
    	HashMapLockItem(YAC_HashMap *pMap, size_t iAddr);
    ...
    protected:
         ...
         * @return int
         */
        int set(const string& k, const string& v, vector<YAC_HashMap::BlockData> &vtData);
         ...
         * @return int
         */
        int set(const string& k, vector<YAC_HashMap::BlockData> &vtData);
        ...
        friend class YAC_HashMap;
        friend struct YAC_HashMap::HashMapLockIterator;
    ...
    public:
    	 ...
    	 * @param type
    	 */
    	HashMapLockIterator(YAC_HashMap *pMap, size_t iAddr, int iType, int iOrder);
    ...
    public:
         ...
         * @param iIndex
         */
        HashMapItem(YAC_HashMap *pMap, size_t iIndex);
         ...
         * @return
         */
        void get(vector<YAC_HashMap::BlockData> &vtData);
        ...
        friend class YAC_HashMap;
        friend struct YAC_HashMap::HashMapIterator;
	...
	*/
    ...
    public:
    	 ...
    	 * @param type
    	 */
    	HashMapIterator(YAC_HashMap *pMap, size_t iIndex);
    ...
    /**
     * @brief  设置淘汰方式
     * YAC_HashMap::ERASEBYGET
     * YAC_HashMap::ERASEBYSET
     * @param cEraseMode
     */
...
protected:
    ...
    //禁止copy构造
    YAC_HashMap(const YAC_HashMap &mcm);
    //禁止复制
    YAC_HashMap &operator=(const YAC_HashMap &mcm);
