#ifndef __YAC_RBTREE_H
#define __YAC_RDTREE_H
...
* @brief RBTree map异常类
*/
struct YAC_RBTree_Exception : public YAC_Exception
{
    YAC_RBTree_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_RBTree_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_RBTree_Exception() throw(){};
};
 /**
 * @brief 内存rbtree，不要直接使用该类，通过jmem组件来使用 
 *  
 *  该红黑树通过YAC_MemMutilChunkAllocator来分配空间，支持不同大小的内存块的分配,
 *  
...
public:
    ...
    */
    ...
    public:
         ...
         * @param pAdd
         */
        Block(YAC_RBTree *pMap, uint32_t iAddr)
        : _pMap(pMap)
        , _iHead(iAddr)
        {
         ...
         *
         * @return int
         *          YAC_RBTree::RT_OK, 正常, 其他异常
         *          YAC_RBTree::RT_ONLY_KEY, 只有Key
         *          其他异常
         */
        int getBlockData(YAC_RBTree::BlockData &data);
         ...
         * @param vtData, 淘汰的数据
         */
        int set(const string& k, const string& v, bool bNewBlock, bool bOnlyKey, vector<YAC_RBTree::BlockData> &vtData);
    ...
    protected:
         ...
         * @return int,
         */
        int allocate(uint32_t iDataLen, vector<YAC_RBTree::BlockData> &vtData);
         ...
         * @return int
         */
        int allocateChunk(uint32_t fn, vector<uint32_t> &chunks, vector<YAC_RBTree::BlockData> &vtData);
         ...
         * 插入到get/set链表中
         */
        void insertGetSetList(YAC_RBTree::Block::tagBlockHead *i);
    ...
    */
    ...
    public:
         ...
         * 构造函数
         */
        BlockAllocator(YAC_RBTree *pMap)
        : _pMap(pMap)
         ...
         */
        uint32_t allocateMemBlock(uint32_t &iAllocSize, vector<YAC_RBTree::BlockData> &vtData);
         ...
         * @return uint32_t, 相对地址,0表示没有空间可以分配
         */
        uint32_t allocateChunk(uint32_t iAddr, uint32_t &iAllocSize, vector<YAC_RBTree::BlockData> &vtData);
    ...
    public:
         ...
         * @param iAddr
         */
        RBTreeLockItem(YAC_RBTree *pMap, uint32_t iAddr);
    ...
    protected:
         ...
         * @return int
         */
        int set(const string& k, const string& v, bool bNewBlock, vector<YAC_RBTree::BlockData> &vtData);
         ...
         * @return int
         */
        int set(const string& k, bool bNewBlock, vector<YAC_RBTree::BlockData> &vtData);
        ...
        friend class YAC_RBTree;
        friend struct YAC_RBTree::RBTreeLockIterator;
    ...
    public:
         ...
         * @param type
         */
        RBTreeLockIterator(YAC_RBTree *pMap, uint32_t iAddr, int iType, int iOrder);
    ...
    public:
         ...
         * @param key
         */
        RBTreeItem(YAC_RBTree *pMap, const string &key, bool bEnd);
         ...
         *         RT_EXCEPTION_ERR, 异常
         */
        int get(YAC_RBTree::BlockData &stData);
    ...
    protected:
        ...
        friend class YAC_RBTree;
        friend struct YAC_RBTree::RBTreeIterator;
    ...
    public:
         ...
         * @param type
         */
        RBTreeIterator(YAC_RBTree *pMap, const string &key, bool bEnd, int iOrder);
...
public:
    ...
    //定义key比较处理器
    typedef YAC_Functor<bool, TL::TLMaker<const string &, const string &>::Result> less_functor;
    ...
    /**
     * 设置淘汰方式
     * YAC_RBTree::ERASEBYGET
     * YAC_RBTree::ERASEBYSET
     * @param cEraseMode
     */
...
protected:
    ...
    //禁止copy构造
    YAC_RBTree(const YAC_RBTree &mcm);
    //禁止复制
    YAC_RBTree &operator=(const YAC_RBTree &mcm);

    struct FailureRecover
    {
        FailureRecover(YAC_RBTree *pMap) : _pMap(pMap)
        {
            _pMap->doRecover();
        }
