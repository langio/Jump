#ifndef __YAC_CONFIG_H_
#define __YAC_CONFIG_H_
...
* 域分隔符
*/
const char YAC_CONFIG_DOMAIN_SEP = '/';

/**
* 参数开始符
*/
const char YAC_CONFIG_PARAM_BEGIN = '<';

/**
* 参数结束符
*/
const char YAC_CONFIG_PARAM_END = '>';

/**
* @brief 配置文件异常类.
*/
struct YAC_Config_Exception : public YAC_Exception
{
	YAC_Config_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_Config_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
	~YAC_Config_Exception() throw(){};
};

/**
 * @brief 配置没有文件错误
 */
struct YAC_ConfigNoParam_Exception : public YAC_Exception
{
	YAC_ConfigNoParam_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_ConfigNoParam_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
	~YAC_ConfigNoParam_Exception() throw(){};
};
...
* @brief 定义配置文件中的域的类. 
*/
class YAC_ConfigDomain
{
public:
    friend class YAC_Config;
    ...
    */
    YAC_ConfigDomain(const string &sLine);
    ...
    */
	 ...
	 * @brief 拷贝复制.
	 *  
     * @param tcd 一个YAC_ConfigDomain对象，指配置文件的一个域
     */
    YAC_ConfigDomain(const YAC_ConfigDomain &tcd);
	 ...
	 * @param tcd 一个YAC_ConfigDomain对象，指配置文件的一个域
     */
    YAC_ConfigDomain& operator=(const YAC_ConfigDomain &tcd);
	...
	*  
	* @param name               子域的名称 
	* @return YAC_ConfigDomain*  指向子域的指针 
	* @throws YAC_Config_Exception 
    */
    YAC_ConfigDomain* addSubDomain(const string& name);
	...
	* @return YAC_ConfigDomain* 指向目标子域的指针
    */
    YAC_ConfigDomain *getSubTcConfigDomain(vector<string>::const_iterator itBegin, vector<string>::const_iterator itEnd);
    const YAC_ConfigDomain *getSubTcConfigDomain(vector<string>::const_iterator itBegin, vector<string>::const_iterator itEnd) const;
    ...
    * @return map
    */
    const map<string, YAC_ConfigDomain*>& getDomainMap() const { return _subdomain; }
    ...
    */
     ...
     * @brief 克隆.
     * 
     * @return YAC_ConfigDomain*
     */
    YAC_ConfigDomain* clone() const 
    { 
        return new YAC_ConfigDomain(*this); 
    }
...
protected:
    ...
    * 子域
    */
    map<string, YAC_ConfigDomain*>	    _subdomain;
...
public:
    ...
    */
	 ...
	 * @brief 拷贝复制.
	 *  
     * @param tc为YAC_Config类型
     */
    YAC_Config(const YAC_Config &tc);
     ...
     * @return YAC_Config&
     */
    YAC_Config& operator=(const YAC_Config &tc);
    ...
    */
     ...
     */
    void joinConfig(const YAC_Config &cf, bool bUpdate);
...
protected:
    /**
	* @brief Parse输入流， 
	* 最终把输入流解析成为一个YAC_ConfigDomain装入stack中 
	* @param  要解析的输入流，按行解析 
    * @throws YAC_Config_Exception
    * @return
    */
	...
	* @throws YAC_Config_Exception 
    */
    YAC_ConfigDomain *newTcConfigDomain(const string& sName);
    ...
    * @return value
    */
	YAC_ConfigDomain *searchTcConfigDomain(const vector<string>& domains);
	const YAC_ConfigDomain *searchTcConfigDomain(const vector<string>& domains) const;
...
protected:
    ...
    * 根domain
    */
	YAC_ConfigDomain _root;
};

}
#endif //_YAC_CONFIG_H_
