#ifndef	__YAC_BIT_MAP_H__
#define __YAC_BIT_MAP_H__
 ...
 * @brief 异常
 */
struct YAC_BitMap_Exception : public YAC_Exception
{
	YAC_BitMap_Exception(const string &buffer) : YAC_Exception(buffer){};
	~YAC_BitMap_Exception() throw(){};
};
