#ifndef __YAC_PARSEPARA_H
#define __YAC_PARSEPARA_H
...
public:
    ...
    * @param 型如name=value&name=value字符串
    */
	YAC_Parsepara(const string &sParam);

    /**
    * @brief  copy contructor
    * @param : name=value&name=value字符串
    */
	YAC_Parsepara(const map<string, string> &mpParam);

    /**
    * @brief  copy contructor
    */
	YAC_Parsepara(const YAC_Parsepara &para);

    /**
    * =
    */
	YAC_Parsepara &operator=(const YAC_Parsepara &para);

    /**
    * ==
    */
	bool operator==(const YAC_Parsepara &para);

    /**
    *+
    */
	const YAC_Parsepara operator+(const YAC_Parsepara &para);
    ...
    * @param 参数值
    */
	typedef int (*YAC_ParseparaTraverseFunc)(string, string, void *);
    ...
    * @return void
    */
	void traverse(YAC_ParseparaTraverseFunc func, void *pParam);
