...
* @brief MMap异常
*/
struct YAC_Mmap_Exception : public YAC_Exception
{
    YAC_Mmap_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_Mmap_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_Mmap_Exception() throw() {};
};
