#ifndef __YAC_FILE_H_
#define __YAC_FILE_H_
...
*  
*/
struct YAC_File_Exception : public YAC_Exception
{
    YAC_File_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_File_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_File_Exception() throw(){};
};
