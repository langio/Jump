#ifndef __YAC_SOCKET_H
#define __YAC_SOCKET_H
...
* @brief socket异常类
*/
struct YAC_Socket_Exception : public YAC_Exception
{
    YAC_Socket_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_Socket_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_Socket_Exception() throw() {};
};

/**
 * @brief 建立链接异常
 */
struct YAC_SocketConnect_Exception : public YAC_Socket_Exception
{
    YAC_SocketConnect_Exception(const string &buffer) : YAC_Socket_Exception(buffer){};
    YAC_SocketConnect_Exception(const string &buffer, int err) : YAC_Socket_Exception(buffer, err){};
    ~YAC_SocketConnect_Exception() throw() {};
};
...
public:
    ...
    */
	int accept(YAC_Socket &tcSock, struct sockaddr *pstSockAddr, socklen_t &iSockLen);
    ...
    */
	 ...
	 *  	  通过connect的返回值,在异步连接的时候需要
     * @param sPathName
     * @throws YAC_Socket_Exception:其他错误还是通过异常返回(例如),例如地址错误
     * @return int
     */
...
private:
	...
	*  
    */
	YAC_Socket(const YAC_Socket &tcSock);

    /**
    * @brief  no implementation.
    */
	YAC_Socket& operator=(const YAC_Socket &tcSock);
