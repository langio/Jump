...
* 编解码抛出的异常
*/
struct YAC_Json_Exception : public YAC_Exception
{
    YAC_Json_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_Json_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_Json_Exception() throw(){};
};
 ...
 * json类型的基类。没有任何意义
 */
class JsonValue : public util::YAC_HandleBase
{
public:
    virtual eJsonType getType()=0;
    virtual ~JsonValue(){}
};
typedef util::YAC_AutoPtr<JsonValue> JsonValuePtr;
...
typedef util::YAC_AutoPtr<JsonValueString> JsonValueStringPtr;
...
typedef util::YAC_AutoPtr<JsonValueNum> JsonValueNumPtr;
...
typedef util::YAC_AutoPtr<JsonValueObj> JsonValueObjPtr;
...
typedef util::YAC_AutoPtr<JsonValueArray> JsonValueArrayPtr;
...
typedef util::YAC_AutoPtr<JsonValueBoolean> JsonValueBooleanPtr;
