#ifndef	__YAC_HASHMAP_COMPACT_H__
#define __YAC_HASHMAP_COMPACT_H__
...
* @brief Hash map异常类
*/
struct YAC_HashMapCompact_Exception : public YAC_Exception
{
	YAC_HashMapCompact_Exception(const string &buffer) : YAC_Exception(buffer){};
    YAC_HashMapCompact_Exception(const string &buffer, int err) : YAC_Exception(buffer, err){};
    ~YAC_HashMapCompact_Exception() throw(){};
};

////////////////////////////////////////////////////////////////////////////////////
/**
 * @brief 紧凑性hashmap.
 * 基于内存的hashmap,所有操作需要自己加锁 , 使用方式同YAC_Hashmap，但是64位系统下更节约额外的管理空间
 */
class YAC_HashMapCompact
{
public:
    ...
    */
    ...
    public:
         ...
         * @param pAdd
         */
        Block(YAC_HashMapCompact *pMap, uint32_t iAddr)
        : _pMap(pMap)
        , _iHead(iAddr)
        {
		...
		*/
         ...
         *
         * @return int
         *          YAC_HashMapCompact::RT_OK, 正常, 其他异常
         *          YAC_HashMapCompact::RT_ONLY_KEY, 只有Key
         *          其他异常
         */
        int getBlockData(YAC_HashMapCompact::BlockData &data);
         ...
         * @param vtData, 淘汰的数据
         */
        int set(const string& k, const string& v, uint32_t iExpireTime, uint8_t iVersion, bool bNewBlock, bool bOnlyKey, vector<YAC_HashMapCompact::BlockData> &vtData);
    ...
    protected:
         ...
         * @return int,
         */
        int allocate(uint32_t iDataLen, vector<YAC_HashMapCompact::BlockData> &vtData);
         ...
         * @return        int
         */
        int allocateChunk(uint32_t fn, vector<uint32_t> &chunks, vector<YAC_HashMapCompact::BlockData> &vtData);
    ...
    */
    ...
    public:
         ...
         * @brief 构造函数
         */
        BlockAllocator(YAC_HashMapCompact *pMap)
        : _pMap(pMap)
         ...
         * @brief 获取每种数据块头部信息
         *
         * @return YAC_MemChunk::tagChunkHead
         */
         ...
         */
        uint32_t allocateMemBlock(uint32_t index, uint32_t &iAllocSize, vector<YAC_HashMapCompact::BlockData> &vtData);
         ...
         * @return size_t, 相对地址,0表示没有空间可以分配
         */
        uint32_t allocateChunk(uint32_t iAddr, uint32_t &iAllocSize, vector<YAC_HashMapCompact::BlockData> &vtData);
    ...
    public:
         ...
         * @param iAddr
    	 */
    	HashMapLockItem(YAC_HashMapCompact *pMap, uint32_t iAddr);
    ...
    protected:
         ...
         * @return int
         */
        int set(const string& k, const string& v, uint32_t iExpireTime, uint8_t iVersion, bool bNewBlock, vector<YAC_HashMapCompact::BlockData> &vtData);
         ...
         * @return int
         */
        int set(const string& k, uint8_t iVersion, bool bNewBlock, vector<YAC_HashMapCompact::BlockData> &vtData);
        ...
        friend class YAC_HashMapCompact;
        friend struct YAC_HashMapCompact::HashMapLockIterator;
    ...
    public:
    	 ...
    	 * @param type
    	 */
    	HashMapLockIterator(YAC_HashMapCompact *pMap, uint32_t iAddr, int iType, int iOrder);
    ...
    public:
         ...
         * @param iIndex
         */
        HashMapItem(YAC_HashMapCompact *pMap, uint32_t iIndex);
         ...
         * @return
         */
        void get(vector<YAC_HashMapCompact::BlockData> &vtData);
         ...
         * @return
         */
        void getExpire(uint32_t t, vector<YAC_HashMapCompact::BlockData> &vtData);
        ...
        friend class YAC_HashMapCompact;
        friend struct YAC_HashMapCompact::HashMapIterator;
    ...
    public:
    	 ...
    	 * @param type
    	 */
    	HashMapIterator(YAC_HashMapCompact *pMap, uint32_t iIndex);
	 ...
	 * @brief 定义hash处理器
	  */
    typedef YAC_Functor<size_t, TL::TLMaker<const string &>::Result> hash_functor;
    ...
    /**
     * @brief 设置淘汰方式
     * YAC_HashMapCompact::ERASEBYGET
     * YAC_HashMapCompact::ERASEBYSET
     * @param cEraseMode
     */
...
public:
    ...
    {
        FailureRecover(YAC_HashMapCompact *pMap) : _pMap(pMap)
        {
            _pMap->doRecover();
        }
...
protected:
	 ...
	 * @brief 禁止copy构造
	 *  */
    YAC_HashMapCompact(const YAC_HashMapCompact &mcm);
    /**
	 * @brief 禁止复制
	 *  */
    YAC_HashMapCompact &operator=(const YAC_HashMapCompact &mcm);
